...
# oras pelcare, oras sosire
# nu de persoane
# consum
class Roady:

    def __init__(self, departure_city: str, destination_city: str, number_of_persons: int,
                 fuel_usage: float, fuel = "benzina", path: str="config.json"):
    ...
    def calculate_prie_per_person(self):
...
if __name__ == '__main__':
    ...
    print(roady1.calculate_prie_per_person())
